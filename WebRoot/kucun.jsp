...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="CSS/kucun.css">
...
<p>药品库存情况一览表</p><br>
<center>
<form action="kucun.jsp" method="post">
	<center>
...
<%
		...
		if(pageNow<=1)
		{
			out.println("<a href=kucun.jsp?pageNow="+(pageNow+1)+">"+"下一页"+"</a>");
		}else if(pageNow>=pageCount)
		{
			out.println("<a href=kucun.jsp?pageNow="+(pageNow-1)+">"+"上一页"+"</a>");
